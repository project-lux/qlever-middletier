...
const keyFuncNameMap = {
  agent: {
    ...
    "lux:agentCreatedPublishedInfluencedWork": queries.worksCreatedPublishedInfluencedByAgent.name,
    ...
    "lux:agentMadeDiscoveredInfluencedItem": queries.itemsProducedEncounteredInfluencedByAgent.name,
...
export { buildEstimatesQuery, queryBuilders };
